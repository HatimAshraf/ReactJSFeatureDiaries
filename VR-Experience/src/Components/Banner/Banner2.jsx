            ...
            <div className='relative z-10 space-y-5'>
              ...
              >
                ...
                <span className='bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary'>
                  VR WITH OUR PLATFORM
                </span>
              </h1>
              <p data-aos='fade-up' data-aos-delay='500'>
                Dive into a whole new world of entertainment! Enjoy your
                favorite movies in breathtaking virtual reality, where every
                scene feels real and immersive.
              </p>
