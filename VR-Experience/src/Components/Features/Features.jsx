...
const FeaturesData = [
  {
    ...
    link: '#',
    description: 'Step Into the Future of Gaming & Movies',
    aosDelay: '300',
  },
  {
    ...
    link: '#',
    description: 'Immerse Yourself in Next-Level VR Entertainment',
    aosDelay: '500',
  },
  {
    ...
    link: '#',
    description: 'Escape Reality, Enter the World of VR',
    aosDelay: '700',
  },
];
